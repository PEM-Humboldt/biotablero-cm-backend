...
/// </summary>
public interface IInitiativeUserService : IRead<InitiativeUser, InitiativeUserDto, int>, IServiceAdd<InitiativeUserDto>, IServiceUpdate<InitiativeUserDto, int>, IServiceDelete<int>
{
    /// <summary>

...
public interface IInitiativeRepository : IRepository<Initiative, int>
{
    ...
    /// <param name="ct">Cancellation token.</param>
    /// <returns>True if any element exists. False otherwise.</returns>
    public Task<bool> IsDuplicatedAsync(int id, string name, CancellationToken ct = default);
    ...
    /// <param name="ct">Cancellation token.</param>
    /// <returns>True if any element exists. False otherwise.</returns>
    public Task<bool> AnyByTagAsync(int tagId, CancellationToken ct = default);
